...
st.set_page_config(page_title="FlixPredict",
                   layout="wide",
                  )
...
def main():
    ...
    def initial_options():
        # Large, bold, center-aligned title using HTML
        st.markdown(
            """
            <h1 style='text-align: center; 
                ...
                🎬 FlixPredict: Ultimate Movie Companion
            </h1>
            <br>
            """,
            unsafe_allow_html=True
        ...
        option = st.radio(
            label="",
            options=["Recommend me a similar movie", "Describe me a movie", "All Movies"],
            horizontal=True,
            index=0,
            key="menu_choice"
        )
        ...
        if option == 'Recommend me a similar movie':
            recommend_display()

        elif option == 'Describe me a movie':
